    ...
    <div class="x_panel">
      ...
      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('customerDetail.update',$customerDetail->id)}}">
        ...
        <div class="item form-group">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Street Address<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 ">
                <textarea id="str_address" required="required" class="form-control" name="str_address" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10">
                    {{$customerDetail->str_address}}
                </textarea>
            </div>
          </div>
          {{-- <div class="item form-group">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">City/Town<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 ">
