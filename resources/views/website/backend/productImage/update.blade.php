...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br>
      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('productImage.update',$productImage->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" >Image Title<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 ">
            <input type="text" id="img_title" name="img_title" value="{{$productImage->img_title}}" required="required" class="form-control ">
            </div>
          </div>
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Image<span class="required">*</span>
                ...
                {{-- <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="form_upload.html" class="dropzone dz-clickable"><div class="dz-default dz-message"><span>Drag files or Click here to upload</span></div></form>
                    <br>
                    <br>
                    <br>
                    <br>
