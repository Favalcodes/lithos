    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div id="datatable-responsive_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
          ...
          <thead>
            <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 94px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">
                    Product Category
                </th>
                <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 93px;" aria-label="Last name: activate to sort column ascending">
                    Status
                </th>
                <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 93px;" aria-label="Last name: activate to sort column ascending">
                    Slug
          ...
          <tbody>
              ...
              <tr role="row">
                ...
                <td>{{ $category->slug }}</td>
                <td>
                <a class="btn btn-app" href="{{ route('category.edit', $category->id)}}">
