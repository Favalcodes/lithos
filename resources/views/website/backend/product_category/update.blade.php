...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br>
            <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('category.update', $category->id)}}">
                @csrf
                @method('PUT')
                ...
                <div class="item form-group">
                    ...
                    <input type="text" value="{{ $category->brand_name}}" id="brand_name" name="brand_name" required="required" class="form-control ">
                    </div>
                </div>
                {{-- <div class="item form-group">
